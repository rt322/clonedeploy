      ...
      <div className="grid grid-cols-12">
        ...
        <div className="col-span-9">
          {list.length > 0 ? (
            ...
            <div>
              <h3 className="text font-bold text-center border-4 border-red-500 text-3xl my-4 lg:mx-0 mx-6 p-3 rounded-lg">
                No Hotel found! Check All Hotels and then decide price range.
              </h3>
              {hotels &&
                hotels.map((e) => (
                  <div className="m-5" key={e._id}>
